...
export const createSocketMainContext = () => createContext<{
	client: NewWebSocketClient | null;
	connectInfo:  NewWebSocketInfo | null;
	connect:  ()  =>  void;
	stop:  ()  =>  void;
	disconnect:  ()  =>  void;
	sendMessage: <T extends Array<SocketSubMessageDTO>>(req: T, callback?: SocketCallbackDTO<T>) => void
	subscribe: <T extends Array<string>>(req: T, callback?: SocketCallbackDTO<T>) => void
