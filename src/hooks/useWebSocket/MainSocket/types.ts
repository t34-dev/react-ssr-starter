...
export interface MainSocketRequest<
	T extends string,
	U extends SocketValue | undefined = undefined,
	V extends SocketPayload | undefined = undefined,
> {
	op: T;
	args?: U;
	data?: V;
...
export type MainSocketResponseDTO =
	| MainSocketSubscribeResponseDTO
	| MainSocketSubscribeResponseDataDTO
	| MainSocketMessageResponseDTO;
...
export type MainSocketCallbackDTO = MainSubscribeCallback<
	MainSocketSubscribeResponseDataDTO | MainSocketMessageResponseDTO
>;
...
// ================================ Sockets
export type MainSocketSubscribeRequestDTO = MainSocketRequest<
	'subscribe' | 'unsubscribe',
	string
>;
export type MainSocketSubscribeResponseDTO = MainSocketRequest<
	'subscribe' | 'unsubscribe',
	string
>;
export type MainSocketSubscribeResponseDataDTO = MainSocketRequest<
	'subscribe',
	string,
	SocketValue
>;
...
export type SocketSubMessageTypeDTO<
	TOp extends string,
	TArgs extends SocketValue,
	TData extends SocketValue,
> = {
	op: TOp;
	args?: TArgs;
	data?: TData;
};
export type SocketSubMessageMarketDTO = SocketSubMessageTypeDTO<
	'getMarkets',
	{
		cat: string;
		value: number;
...
>;
export type SocketSubMessageAssetDTO = SocketSubMessageTypeDTO<
	'getAssets',
	{
		cat: string;
		value: number;
...
export type SocketSubMessageDTO =
